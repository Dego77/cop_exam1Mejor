...
import { handleTextPrompt, handlePhotoPrompt, handleVoicePrompt, getAIChatHistory, handleSupportPrompt } from '../controllers/ai.controller';
...
router.post('/support', handleSupportPrompt);
